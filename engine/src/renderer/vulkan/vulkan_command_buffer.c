...
void vulkan_command_buffer_allocate(vulkan_context* context, VkCommandPool pool, bool is_primary, vulkan_command_buffer* out_command_buffer) {
    memset(out_command_buffer, 0, sizeof(vulkan_command_buffer));
