...
DAPI bool inupt_was_button_down(buttons button);
DAPI bool inut_was_button_up(buttons button);
DAPI void input_get_mouse_position(int* x, int* y);
DAPI void input_get_previous_mouse_position(int* x, int* y);
