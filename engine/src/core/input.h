...
DAPI bool input_is_key_down(keys key);
DAPI bool input_is_key_up(keys key);
DAPI bool input_was_key_down(keys key);
DAPI bool input_was_key_up(keys key);

void input_process_key(keys key, bool pressed);

DAPI bool input_is_button_down(buttons button);
DAPI bool input_is_button_up(buttons button);
DAPI bool input_was_button_down(buttons button);
DAPI bool input_was_button_up(buttons button);
DAPI void input_get_mouse_position(int32_t* x, int32_t* y);
DAPI void input_get_previous_mouse_position(int32_t* x, int32_t* y);
